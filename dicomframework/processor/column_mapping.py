...
def main_cols():
    return[{'number': '00080005', 'name': 'SpecificCharacterSet'},
           ...
           {'number': '0020000d', 'name': 'StudyInstanceUID'}, # todo: necesitamos 'StudyInstanceUID' para asociar el id con la imagen
